...
class DRAMSim2(DRAMSim2Wrapper):
    ...
    bank_part = Param.Bool(False, "Use bank partitioning")
    tl0 = Param.Int(23, "turn length for thread0")
    tl1 = Param.Int(23, "turn length for thread0")
    tl2 = Param.Int(23, "turn length for thread0")
    tl3 = Param.Int(23, "turn length for thread0")
    tl4 = Param.Int(23, "turn length for thread0")
    tl5 = Param.Int(23, "turn length for thread0")
